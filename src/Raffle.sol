...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    error Raffle_UpkeepNotNeeded(uint256 balance,uint256 players,uint256 raffleState);
    ...
    function enterRaffle() external payable {
        // require(msg.value >= i_entranceFee,SendMoreToEnterRaffle); // only works since 0.8.26
    ...
    function checkUpkeep(bytes memory /*checkData*/)public view returns (
      ...
      bytes memory /* performData */
        ...
        upkeepNeeded = timeHasPassed && isOpen && contractHasBalance && contractHasPlayers;
        return(upkeepNeeded,"");
    }
